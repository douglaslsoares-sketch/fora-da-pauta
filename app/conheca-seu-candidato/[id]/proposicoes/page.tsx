...
export default async function ProposicoesDoCandidatoPage({
  params,
}: {
  params: Promise<{
    id: string;
    ...
    <main className="min-h-screen bg-[#eeeee9] text-[#151515]">
      <header className="bg-black text-white">
        <div className="mx-auto w-full max-w-4xl px-5 pb-8 pt-6 sm:px-8 sm:pb-12 sm:pt-8">
          ...
          <p className="mt-6 text-sm text-white/50">
            {atuacao.totalProposicoes} registros disponíveis
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto w-full max-w-4xl px-5 py-8 sm:px-8 sm:py-12">
        ...
        <p className="mt-6 text-xs leading-5 text-black/40">
          A ordem de assinatura é reproduzida apenas como informação
          documental. Ela não é utilizada como medida de importância,
          autoria exclusiva ou grau de participação.
        </p>
